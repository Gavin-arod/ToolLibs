...
public class PlotAttrInfo {
    ...
    protected List<Float> mAttrInfoPosition = null;
    ...
    public void clearPlotAttrInfo() {
        ...
        if (null != mAttrInfoPosition) mAttrInfoPosition.clear();
    ...
    public void addAttributeInfo(XEnum.Location position, String info,
        ...
        if (null == mAttrInfoLocation) mAttrInfoLocation = new ArrayList<>();
        if (null == mAttrInfo) mAttrInfo = new ArrayList<>();

        if (null == mAttrInfoPosition) mAttrInfoPosition = new ArrayList<>();
        if (null == mAttrInfoPaint) mAttrInfoPaint = new ArrayList<>();

        mAttrInfoLocation.add(position);
        mAttrInfo.add(info);
        mAttrInfoPosition.add(infoPosRadiusPercentage);
