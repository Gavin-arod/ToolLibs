...
import com.tool.view.board.renderer.axis.RoundAxis;
import com.tool.view.board.renderer.axis.RoundAxisRender;
import com.tool.view.board.renderer.plot.PlotAttrInfo;
import com.tool.view.board.renderer.plot.PlotAttrInfoRender;
import com.tool.view.board.renderer.plot.Pointer;
import com.tool.view.board.renderer.plot.PointerRender;
...
public class DialChart extends CirChart {
    ...
    private final List<RoundAxis> mRoundAxis = new ArrayList<>();

    //指针[默认1个，其它add]
    private PointerRender mPointer = null;
    List<Pointer> mPointerSet = new ArrayList<>();
